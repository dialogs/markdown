      ...
      result: [
        {
          ...
          replace: 'Dialog',
          options: { url: 'https://dlg.im', raw: 'https://dlg.im' },
        },
      ],
    },
    {
      ...
      result: [
        {
          ...
          replace: 'dlg.im',
          options: { url: 'http://dlg.im', raw: 'dlg.im' },
        },
      ],
    },
    {
      ...
      result: [
        {
          ...
          replace: 'www.dlg.im',
          options: { url: 'http://www.dlg.im', raw: 'www.dlg.im' },
        },
      ],
    },
    {
      ...
      result: [
        {
          ...
          replace: 'налог.рф',
          options: { url: 'http://налог.рф', raw: 'налог.рф' },
        },
      ],
    },
    {
      ...
      result: [
        {
          ...
          options: {
            url: 'http://site.com/строчные_буквы',
            raw: 'site.com/строчные_буквы',
          },
        },
      ],
    },
      ...
      result: [
        {
          ...
          options: {
            url: 'http://www.some-site.org/здесь_Заголовок',
            raw: 'www.some-site.org/здесь_Заголовок',
          },
        },
      ],
    },
